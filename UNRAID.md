...
| Repository | `ghcr.io/benwisecup/rectifierr-backend:latest` |
| Port | `8000` → `8000` |
...
| Repository | `ghcr.io/benwisecup/rectifierr-frontend:latest` |
| Port | `7878` → `80` |
...
```bash
docker pull ghcr.io/benwisecup/rectifierr-backend:latest
docker pull ghcr.io/benwisecup/rectifierr-frontend:latest
```
